// Last updated: 8/19/2026, 5:41:16 PM
1import java.util.*;
2
3class Solution {
...
13            boolean left  = (seats & 0b00111100) == 0;  // 2-5
14            boolean middle = (seats & 0b11110000) == 0; // 4-7
15            boolean right = (seats & 0b1111000000) == 0; // 6-9
16            if (left && right) {
17                ans += 2;
18            }
